...
export const Settings = (p: P) => (
  <Svg {...p} viewBox="0 0 24 24" strokeWidth={2}>
...
export const Question = (p: P) => (
  <Svg {...p}>
    ...
    <path d="M6.35 6.15A1.8 1.8 0 0 1 8.1 4.8c1.05 0 1.9.68 1.9 1.65 0 1.2-.72 1.55-1.45 2.05-.5.34-.55.75-.55 1.25M8 12.3h.01" />
  </Svg>
);
